...
function setMapSelector(timed) {
  ...
  // فقط دکمه مرحله ۱-۱ رو بساز
  var innerHTML = "";
  innerHTML += createAdderMap(1, 1);
  
  // اضافه کردن دکمه به صفحه (بدون دکمه Map Generator)
  elemSelect.innerHTML += innerHTML;
  ...
  if(!isLocal) {
    ...
    // تنظیمات رنگ دکمه لود شده فقط برای مرحله ۱-۱
    var elem;
    if(game["World11"] && (elem = document.getElementById("maprect1,1"))) {
